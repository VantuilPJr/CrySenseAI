        ...
        <div className="tab-content fade-in">
            ...
            {total === 0 ? (
                <div className="chart-card" style={{ textAlign: 'center', color: 'var(--text-muted)', padding: 40 }}>
                    ...
                    <p style={{ fontSize: '0.82rem', marginTop: 4 }}>Os dados aparecem assim que o bebê chorar e o sistema confirmar. Os dados de sensores ficam na aba Sensores.</p>
                </div>
            ) : (<>
                ...
                <div className="chart-card">
                    ...
                    <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: 8 }}>
                        * Histórico em RAM restaurado do SPIFFS no boot. Máx. 48 episódios. Dados persistem entre reinicializações.
                    </p>
                </div>
