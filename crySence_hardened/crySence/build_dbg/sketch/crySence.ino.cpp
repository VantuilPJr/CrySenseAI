#include <Arduino.h>
#line 1 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
...
#line 59 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
int get_signal_data_callback(size_t offset, size_t length, float *out_ptr);
#line 68 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
static EI_IMPULSE_ERROR run_trigger_model(signal_t *signal, ei_impulse_result_t *result);
#line 73 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
static EI_IMPULSE_ERROR run_type_model(signal_t *signal, ei_impulse_result_t *result);
#line 97 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
void TaskIA(void *pv);
#line 306 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
static void registrar(TipoChoro t);
#line 313 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
static void dispararAlerta(const char *tipo, float conf);
#line 347 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
void TaskDecisao(void *pv);
#line 513 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
void setup();
#line 685 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
void loop();
#line 59 "C:\\Arduino\\crySense_ai\\crySence_hardened\\crySence\\crySence.ino"
int get_signal_data_callback(size_t offset, size_t length, float *out_ptr) {
